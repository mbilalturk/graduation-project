...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\textwidth]{comprehensive_evaluation.png}
    \caption{\label{fig:comprehensive}Comprehensive evaluation of the models on route 502: overall error comparison together with error diagnostics.}
\end{figure}
...
Breaking the error down by operating condition (Table~\ref{tab:condition}, with the weather and time-of-day effects also shown in Figure~\ref{fig:weather}) reveals where the difficulty lies and confirms that all three learned models behave consistently.
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\textwidth]{weather_time_impact.png}
    \caption{\label{fig:weather}Impact of weather conditions and time of day on the prediction error.}
\end{figure}
